...
This Git-hub repository contains scripts, data and outputs used to reconstruct, translate, align, and phylogenetically analyse unknown DNA barcoded meat samples using bioinformatic analysis. The project aims to identify the species of origin of samples intercepted at Heathrow Airport.
